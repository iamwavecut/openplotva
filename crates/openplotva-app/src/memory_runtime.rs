...
pub const MEMORY_SUBJECT_MERGE_INTERVAL: Duration = Duration::from_secs(30);
pub const MEMORY_SUBJECT_MERGE_COOLDOWN_HOURS: f64 = 72.0;
pub const MEMORY_SUBJECT_MERGE_MIN_CARDS: i64 = 3;
pub const MEMORY_SUBJECT_MERGE_GROUP_BATCH: i64 = 8;
