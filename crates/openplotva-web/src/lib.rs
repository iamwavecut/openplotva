...
const ADMIN_ASSETS: &[StaticAsset] = &[
    ...
    StaticAsset {
        ...
        sha256: "45da119b5a77937c8316cf1aa5844f9fc5fdf5376231c4985e0395d0e7ac2562",
    },
    StaticAsset {
        path: "login.html",
        content_type: "text/html; charset=utf-8",
...
mod tests {
    ...
    fn admin_gradius_audit_has_filters_lifecycle_states_and_safe_detail_views() {
        for marker in [
            ...
            "Privacy-filtered payloads in the exact order sent to the provider.",
            "Trigger and result context (privacy-filtered)",
            "Raw JSON",
